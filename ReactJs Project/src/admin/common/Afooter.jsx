    ...
    return (
        ...
        <div className="container-fluid bg-dark text-white-50 py-5 px-sm-3 px-lg-5" style={{marginTop: 90}}>
            ...
            <div className="col-lg-3 col-md-6 mb-5">
                ...
                <h1 className="text-primary"><span className="text-white">Glob</span>Trekker</h1>
                </a>
            ...
            <div className="col-lg-3 col-md-6 mb-5">
                ...
                <p><i className="fa fa-map-marker-alt mr-2" />123 Street, New Delhi, INDIA</p>
        ...
        <div className="container-fluid bg-dark text-white border-top py-4 px-sm-3 px-md-5" style={{borderColor: 'rgba(256, 256, 256, .1) !important'}}>
            ...
            <div className="col-lg-6 text-center text-md-right">
                <p className="m-0 text-white-50">Designed by <a href="/">Mahima Raol</a>
                </p>
            </div>
            </div>
        </div>
